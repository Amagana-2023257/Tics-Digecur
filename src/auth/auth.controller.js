...
/* ============================================================================
 * Controllers con auditoría
 * ==========================================================================*/

/**
 * POST /auth/register
 * Registro controlado de usuario base (roles por defecto en el modelo).
 */
export const register = async (req, res) => {
  ...
  try {
    const { email, password, nombre, departamento, cargo } = req.body;
    ...
    if (exists) {
      ...
      return handleErrorResponse(res, 400, 'El email ya está en uso');
    }

    const user = new User({
      email,
      password, // se hashea en pre('save') del modelo (argon2/bcrypt según tu modelo)
      nombre,
      departamento,
      cargo,
    });
